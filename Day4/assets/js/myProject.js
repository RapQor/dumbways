...
function useFormattedDates(startDate, endDate, startYear) {
    ...
    if (mulai && akhir) {
        ...
        return { years: diffYears, months: diffMonths, days: diffDays, startYear};
    } else {
...
const startYear = useFormattedDates(formattedDates.startDate, formattedDates.endDate);
...
function submitBlog(event){
    ...
    let typeScript = document.getElementById("nodeJs").checked
        ...
        document.getElementById("content").innerHTML += `
            <div class="blog-list-items">
                ...
                <div class="blog-content">
                    ...
                    <div class="languages">
                        ${dataBlog[index].nodeJs ? "<img src='nodejs.png' alt='Node.js' class=\"img-lang\" />" : ""}
                        ${dataBlog[index].reactJs ? "<img src='developer.png' alt='React' class=\"img-lang\" />" : ""}
                        ${dataBlog[index].nextJs ? "<img src='next.png' alt='Next.js' class=\"img-lang\" />" : ""}
                        ${dataBlog[index].typeScript ? "<img src='typscript.png' alt='Java' class=\"img-lang\"z />" : ""}
                    </div>
                    <div class="btn-group">
